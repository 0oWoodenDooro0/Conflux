...
class ServerApiClient(private val client: HttpClient) {
    // Basic constructor for common use, can be improved with platform engines later
    ...
    suspend fun createServer(name: String, iconUrl: String?): Server {
        return client.post("/api/servers") {
