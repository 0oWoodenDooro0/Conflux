...
interface ServerService {
    suspend fun createServer(name: String, ownerId: String, icon: String? = null, description: String? = null): Server?
    ...
    suspend fun joinByInviteCode(userId: String, inviteCode: String): Server?
}
